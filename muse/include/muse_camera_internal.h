...
#define NEED_RELEASE_BUFFER(x) \
	((x)->preview_cb_flag && !((x)->preview_cb_flag == (PREVIEW_CB_TYPE_USER | PREVIEW_CB_TYPE_EVAS)) && \
	(((x)->preview_cb_flag == PREVIEW_CB_TYPE_USER) || ((x)->preview_cb_flag == PREVIEW_CB_TYPE_EVAS)))
