 ...
 * @see	camera_destroy()
 */
int mmsvc_camera_create(camera_device_e device, camera_h *camera);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_create()
 */
int mmsvc_camera_destroy(camera_h camera);
 ...
 *         mmsvc_camera_preview_cb() will be called when preview image data becomes available.
 *
 * @see	camera_stop_preview()
 * @see mmsvc_camera_set_display()
 * @see mmsvc_camera_set_preview_cb()
 * @see mmsvc_camera_set_media_packet_preview_cb()
 * @see mmsvc_camera_foreach_supported_preview_resolution()
 * @see mmsvc_camera_set_preview_resolution()
 * @see mmsvc_camera_get_preview_resolution()
 * @see mmsvc_camera_foreach_supported_preview_format()
 * @see mmsvc_camera_set_preview_format()
 * @see mmsvc_camera_get_preview_format()
 * @see mmsvc_camera_attr_foreach_supported_fps()
 * @see mmsvc_camera_attr_set_preview_fps()
 * @see mmsvc_camera_attr_get_preview_fps()
 */
int mmsvc_camera_start_preview(camera_h camera);
 ...
 * @see	camera_unset_media_packet_preview_cb()
 */
int mmsvc_camera_stop_preview(camera_h camera);
 ...
 *          and the corresponding callback function mmsvc_camera_capturing_cb() and mmsvc_camera_capture_completed_cb() will be invoked\n
 *          The captured image will be delivered through mmsvc_camera_capturing_cb().\n
 *          mmsvc_camera_capture_completed_cb() callback notifies about completion of mmsvc_camera_capturing_cb(). \n
 *          The camera's preview should be restarted by calling mmsvc_camera_start_preview().
 * @param[in] camera The handle to the camera
 ...
 *
 * @see mmsvc_camera_start_preview()
 * @see mmsvc_camera_start_continuous_capture();
 * @see mmsvc_camera_foreach_supported_capture_resolution()
 * @see mmsvc_camera_set_capture_resolution()
 * @see mmsvc_camera_get_capture_resolution()
 * @see mmsvc_camera_foreach_supported_capture_format()
 * @see mmsvc_camera_set_capture_format()
 * @see mmsvc_camera_get_capture_format()
 * @see mmsvc_camera_attr_set_image_quality()
 * @see mmsvc_camera_attr_get_image_quality()
 */
int mmsvc_camera_start_capture(camera_h camera, camera_capturing_cb capturing_cb , camera_capture_completed_cb completed_cb , void *user_data);
 ...
 *          and the corresponding callback function mmsvc_camera_capturing_cb() and mmsvc_camera_capture_completed_cb() will be invoked\n
 *          Each Captured image will be delivered through mmsvc_camera_capturing_cb().\n
 *          The mmsvc_camera_capture_completed_cb() callback notifies about the completion of an entire capture.\n
 *          The camera's preview should be restarted by calling mmsvc_camera_start_preview().\n.
 * @param[in] camera The handle to the camera
 ...
 *
 * @see mmsvc_camera_start_preview()
 * @see mmsvc_camera_start_capture();
 * @see mmsvc_camera_stop_continuous_capture()
 * @see mmsvc_camera_is_supported_zero_shutter_lag()
 */
int mmsvc_camera_start_continuous_capture(camera_h camera, int count, int interval, camera_capturing_cb capturing_cb, camera_capture_completed_cb completed_cb , void *user_data);
 ...
 * @see mmsvc_camera_start_continuous_capture()
 */
int mmsvc_camera_stop_continuous_capture(camera_h camera);
 ...
 * @see mmsvc_camera_create()
 * @see mmsvc_camera_start_preview()
 * @see mmsvc_camera_stop_preview()
 * @see mmsvc_camera_start_capture()
 */
int mmsvc_camera_get_state(camera_h camera, camera_state_e *state);
 ...
 *
 * @see mmsvc_camera_cancel_focusing()
 * @see mmsvc_camera_set_focus_changed_cb()
 * @see mmsvc_camera_focus_changed_cb()
 * @see mmsvc_camera_attr_set_af_mode()
 */
int mmsvc_camera_start_focusing(camera_h camera, bool continuous);
 ...
 * @pre The camera state must be set to #CAMERA_STATE_PREVIEW.
 *
 * @see mmsvc_camera_start_focusing()
 * @see	camera_focus_changed_cb()
 */
int mmsvc_camera_cancel_focusing(camera_h camera);

/**
 * @brief Sets the display handle to show preview images.
 *
 * @since_tizen @if MOBILE 2.3 @elseif WEARABLE 2.3.1 @endif
 * @remarks This function must be called before previewing (see mmsvc_camera_start_preview()).
 * @param[in] camera The handle to the camera
 ...
 * @see #GET_DISPLAY
 */
int mmsvc_camera_set_display(camera_h camera, camera_display_type_e type, camera_display_h display);
 ...
 * @see	camera_foreach_supported_preview_resolution()
 */
int mmsvc_camera_set_preview_resolution(camera_h camera, int width, int height);
 ...
 * @see	camera_foreach_supported_preview_resolution()
 */
int mmsvc_camera_get_preview_resolution(camera_h camera, int *width, int *height);
 ...
 * @see	camera_foreach_supported_preview_resolution()
 */
int mmsvc_camera_get_recommended_preview_resolution(camera_h camera, int *width, int *height);
 ...
 *          When face detection is running, the mmsvc_camera_start_focusing(), mmsvc_camera_cancel_focusing(), mmsvc_camera_attr_set_af_mode(), mmsvc_camera_attr_set_af_area(), mmsvc_camera_attr_set_exposure_mode(), and mmsvc_camera_attr_set_whitebalance() settings are ignored.\n
 *          If mmsvc_camera_stop_preview() is invoked, face detection is stopped and then preview is resumed using mmsvc_camera_start_preview(), this method should be called again to resume face detection.
 * @param[in] camera The handle to the camera
 ...
 *
 * @see mmsvc_camera_stop_face_detection()
 * @see mmsvc_camera_face_detected_cb()
 * @see mmsvc_camera_is_supported_face_detection()
 */
int mmsvc_camera_start_face_detection(camera_h camera, camera_face_detected_cb callback, void * user_data);
 ...
 *
 * @see mmsvc_camera_start_face_detection()
 * @see mmsvc_camera_is_supported_face_detection()
 */
int mmsvc_camera_stop_face_detection(camera_h camera);
 ...
 *
 */
 bool mmsvc_camera_is_supported_continuous_capture(camera_h camera);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @post This function invokes mmsvc_camera_supported_preview_resolution_cb() repeatedly to retrieve each supported preview resolution.
 *
 * @see	camera_set_preview_resolution()
 * @see	camera_get_preview_resolution()
 * @see	camera_supported_preview_resolution_cb()
 */
int mmsvc_camera_foreach_supported_preview_resolution(camera_h camera,
 ...
 * @privlevel public
 * @privilege %http://tizen.org/privilege/camera
 * @remarks This function should be called before previewing (see mmsvc_camera_start_preview())
 * @param[in] camera The handle to the camera
 ...
 */
int mmsvc_camera_set_display_rotation(camera_h camera, camera_rotation_e rotation);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_set_display_rotation()
 */
int mmsvc_camera_get_display_rotation(camera_h camera, camera_rotation_e *rotation);
 ...
 */
int mmsvc_camera_set_display_flip(camera_h camera, camera_flip_e flip);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_set_display_flip()
 */
int mmsvc_camera_get_display_flip(camera_h camera, camera_flip_e *flip);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_is_display_visible()
 */
int mmsvc_camera_set_display_visible(camera_h camera, bool visible);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_set_display_visible()
 */
int mmsvc_camera_is_display_visible(camera_h camera, bool *visible);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_get_display_mode()
 */
int mmsvc_camera_set_display_mode(camera_h camera , camera_display_mode_e mode);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_set_display_mode()
 */
int mmsvc_camera_get_display_mode(camera_h camera, camera_display_mode_e *mode);
 ...
 * @see	camera_foreach_supported_capture_resolution()
 */
int mmsvc_camera_set_capture_resolution(camera_h camera, int width, int height);
 ...
 * @see mmsvc_camera_foreach_supported_capture_resolution()
 */
int mmsvc_camera_get_capture_resolution(camera_h camera, int *width, int *height);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @post This function invokes mmsvc_camera_supported_capture_resolution_cb() repeatedly to retrieve each supported capture resolution.
 * @see mmsvc_camera_set_capture_resolution()
 * @see mmsvc_camera_get_capture_resolution()
 * @see	camera_supported_capture_resolution_cb()
 */
int mmsvc_camera_foreach_supported_capture_resolution(camera_h camera,
 ...
 *
 * @since_tizen @if MOBILE 2.3 @elseif WEARABLE 2.3.1 @endif
 * @remarks This function should be called before capturing (see mmsvc_camera_start_capture()).
 * @param[in] camera The handle to the camera
 ...
 * @see	camera_foreach_supported_capture_format()
 */
int mmsvc_camera_set_capture_format(camera_h camera, camera_pixel_format_e format);
 ...
 * @see	camera_foreach_supported_capture_format()
 */
int mmsvc_camera_get_capture_format(camera_h camera, camera_pixel_format_e *format);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @post This function invokes mmsvc_camera_supported_capture_format_cb() repeatedly to retrieve each supported capture format.
 * @see	camera_set_capture_format()
 * @see	camera_get_capture_format()
 * @see	camera_supported_capture_format_cb()
 */
int mmsvc_camera_foreach_supported_capture_format(camera_h camera,
 ...
 * @see	camera_foreach_supported_preview_format()
 */
int mmsvc_camera_set_preview_format(camera_h camera, camera_pixel_format_e format);
 ...
 * @see	camera_foreach_supported_preview_format()
 */
int mmsvc_camera_get_preview_format(camera_h camera, camera_pixel_format_e *format);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @post This function invokes mmsvc_camera_supported_preview_format_cb() repeatly to retrieve each supported preview format.
 * @see	camera_set_preview_format()
 * @see	camera_get_preview_format()
 * @see	camera_supported_preview_format_cb()
 */
int mmsvc_camera_foreach_supported_preview_format(camera_h camera,
 ...
 * @exception #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 */
bool mmsvc_camera_is_supported_face_detection(camera_h camera);
 ...
 *
 */
bool mmsvc_camera_is_supported_zero_shutter_lag(camera_h camera);
 ...
 *
 */
int mmsvc_camera_get_device_count(camera_h camera, int *device_count);
 ...
 *
 */
bool mmsvc_camera_is_supported_media_packet_preview_cb(camera_h camera);
 ...
 *          This function should be called before previewing (see mmsvc_camera_start_preview()).\n
 ...
 * @see	camera_start_preview()
 * @see mmsvc_camera_unset_preview_cb()
 * @see	camera_preview_cb()
 */
int mmsvc_camera_set_preview_cb(camera_h camera, camera_preview_cb callback, void *user_data);
 ...
 * @see mmsvc_camera_set_preview_cb()
 */
int mmsvc_camera_unset_preview_cb(camera_h camera);
 ...
 */
int mmsvc_camera_set_media_packet_preview_cb(camera_h camera, camera_media_packet_preview_cb callback, void *user_data);
 ...
 * @see	camera_set_media_packet_preview_cb()
 */
int mmsvc_camera_unset_media_packet_preview_cb(camera_h camera);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @post This function will invoke mmsvc_camera_state_changed_cb() when the camera state changes.
 * @see mmsvc_camera_unset_state_changed_cb()
 * @see	camera_state_changed_cb()
 */
int mmsvc_camera_set_state_changed_cb(camera_h camera, camera_state_changed_cb callback,
        void *user_data);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_set_state_changed_cb()
 */
int mmsvc_camera_unset_state_changed_cb(camera_h camera);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_unset_interrupted_cb()
 * @see	camera_interrupted_cb()
 */
int mmsvc_camera_set_interrupted_cb(camera_h camera, camera_interrupted_cb callback,
	    void *user_data);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_set_interrupted_cb()
 */
int mmsvc_camera_unset_interrupted_cb(camera_h camera);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @post This function will invoke mmsvc_camera_focus_changed_cb() when the auto-focus state changes.
 * @see	camera_start_focusing()
 * @see	camera_cancel_focusing()
 * @see	camera_unset_focus_changed_cb()
 * @see	camera_focus_changed_cb()
 */
int mmsvc_camera_set_focus_changed_cb(camera_h camera, camera_focus_changed_cb callback,
        void *user_data);
 ...
 * @see mmsvc_camera_set_focus_changed_cb()
 */
int mmsvc_camera_unset_focus_changed_cb(camera_h camera);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @post This function will invoke mmsvc_camera_error_cb() when an asynchronous operation error occurs.

 * @see mmsvc_camera_unset_error_cb()
 * @see	camera_error_cb()
 */
int mmsvc_camera_set_error_cb(camera_h camera, camera_error_cb callback, void *user_data);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_set_error_cb()
 */
int mmsvc_camera_unset_error_cb(camera_h camera);
 ...
 * @see	camera_attr_foreach_supported_fps()
 */
int mmsvc_camera_attr_set_preview_fps(camera_h camera, camera_attr_fps_e fps);
 ...
 * @see	camera_attr_foreach_supported_fps()
 */
int mmsvc_camera_attr_get_preview_fps(camera_h camera, camera_attr_fps_e *fps);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @post This function invokes mmsvc_camera_attr_supported_fps_cb() repeatly to get each supported FPS mode.
 * @see	camera_attr_set_preview_fps()
 * @see	camera_attr_get_preview_fps()
 * @see	camera_attr_supported_fps_cb()
 */
int mmsvc_camera_attr_foreach_supported_fps(camera_h camera, camera_attr_supported_fps_cb callback,
        void *user_data);
 ...
 * @see	camera_attr_supported_fps_cb()
 */
int mmsvc_camera_attr_foreach_supported_fps_by_resolution(camera_h camera,  int width, int height,
 ...
 */
int mmsvc_camera_attr_set_image_quality(camera_h camera, int quality);
 ...
 * @see mmsvc_camera_attr_set_image_quality()
 */
int mmsvc_camera_attr_get_image_quality(camera_h camera, int *quality);

/**
 * @brief Sets the zoom level.
 * @details The range for the zoom level is received from mmsvc_camera_attr_get_zoom_range(). If @a zoom is out of range, the #CAMERA_ERROR_INVALID_PARAMETER error occurs.
 * @since_tizen @if MOBILE 2.3 @elseif WEARABLE 2.3.1 @endif
 * @privlevel public
 * @privilege %http://tizen.org/privilege/camera
 * @param[in] camera The handle to the camera
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_attr_get_zoom()
 * @see mmsvc_camera_attr_get_zoom_range()
 */
int mmsvc_camera_attr_set_zoom(camera_h camera, int zoom);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_attr_set_zoom()
 * @see mmsvc_camera_attr_get_zoom_range()
 */
int mmsvc_camera_attr_get_zoom(camera_h camera, int *zoom);
 ...
 * @see mmsvc_camera_attr_get_zoom()
 */
int mmsvc_camera_attr_get_zoom_range(camera_h camera , int *min , int *max);
 ...
 */
int mmsvc_camera_attr_set_af_mode(camera_h camera, camera_attr_af_mode_e mode);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_attr_foreach_supported_af_mode()
 * @see mmsvc_camera_attr_set_af_mode()
 * @see	#camera_attr_af_mode_e
 */
int mmsvc_camera_attr_get_af_mode(camera_h camera, camera_attr_af_mode_e *mode);
 ...
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_attr_set_af_mode()
 * @see mmsvc_camera_attr_clear_af_area()
 */
int mmsvc_camera_attr_set_af_area(camera_h camera, int x, int y);
 ...
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_attr_set_af_mode()
 * @see mmsvc_camera_attr_set_af_area()
 */
int mmsvc_camera_attr_clear_af_area(camera_h camera);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @post This function invokes mmsvc_camera_attr_supported_af_mode_cb() to get all the supported auto focus modes.
 * @see mmsvc_camera_attr_set_af_mode()
 * @see mmsvc_camera_attr_get_af_mode()
 * @see	camera_attr_supported_af_mode_cb()
 */
int mmsvc_camera_attr_foreach_supported_af_mode(camera_h camera,
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_attr_get_exposure_mode()
 * @see mmsvc_camera_attr_foreach_supported_exposure_mode()
 */
int mmsvc_camera_attr_set_exposure_mode(camera_h camera, camera_attr_exposure_mode_e mode);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_attr_set_exposure_mode()
 * @see mmsvc_camera_attr_foreach_supported_exposure_mode()
 */
int mmsvc_camera_attr_get_exposure_mode(camera_h camera, camera_attr_exposure_mode_e *mode);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @post This function invokes mmsvc_camera_attr_supported_exposure_mode_cb() to get all the supported exposure modes.
 * @see mmsvc_camera_attr_set_exposure_mode()
 * @see mmsvc_camera_attr_get_exposure_mode()
 * @see	camera_attr_supported_exposure_mode_cb()
 */
int mmsvc_camera_attr_foreach_supported_exposure_mode(camera_h camera,
 ...
 */
int mmsvc_camera_attr_set_exposure(camera_h camera, int value);
 ...
 */
int mmsvc_camera_attr_get_exposure(camera_h camera, int *value);
 ...
 * @see	camera_attr_set_exposure()
 */
int mmsvc_camera_attr_get_exposure_range(camera_h camera, int *min, int *max);
 ...
 * @see mmsvc_camera_attr_foreach_supported_iso()
 */
int mmsvc_camera_attr_set_iso(camera_h camera, camera_attr_iso_e iso);
 ...
 * @see mmsvc_camera_attr_foreach_supported_iso()
 */
int mmsvc_camera_attr_get_iso(camera_h camera, camera_attr_iso_e *iso);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @post This function invokes mmsvc_camera_attr_supported_iso_cb() to get all the supported ISO levels.
 * @see	camera_attr_set_iso()
 * @see mmsvc_camera_attr_get_iso()
 * @see	camera_attr_supported_iso_cb()
 */
int mmsvc_camera_attr_foreach_supported_iso(camera_h camera, camera_attr_supported_iso_cb callback,
        void *user_data);
 ...
 */
int mmsvc_camera_attr_set_theater_mode(camera_h camera, camera_attr_theater_mode_e mode);
 ...
 * @see	camera_attr_get_theater_mode()
 */
int mmsvc_camera_attr_get_theater_mode(camera_h camera, camera_attr_theater_mode_e *mode);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @post This function invokes mmsvc_camera_attr_supported_theater_mode_cb() to get all supported theater modes.
 * @see mmsvc_camera_attr_set_theater_mode()
 * @see mmsvc_camera_attr_get_theater_mode()
 * @see	camera_attr_supported_theater_mode_cb()
 */
int mmsvc_camera_attr_foreach_supported_theater_mode(camera_h camera,
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_attr_get_brightness()
 * @see mmsvc_camera_attr_get_brightness_range()
 */
int mmsvc_camera_attr_set_brightness(camera_h camera, int level);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_attr_set_brightness()
 * @see mmsvc_camera_attr_get_brightness_range()
 */
int mmsvc_camera_attr_get_brightness(camera_h camera, int *level);
 ...
 * @see mmsvc_camera_attr_get_brightness()
 */
int mmsvc_camera_attr_get_brightness_range(camera_h camera, int *min, int *max);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_attr_get_contrast()
 * @see mmsvc_camera_attr_get_contrast_range()
 */
int mmsvc_camera_attr_set_contrast(camera_h camera, int level);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_attr_set_contrast()
 * @see mmsvc_camera_attr_get_contrast_range()
 */
int mmsvc_camera_attr_get_contrast(camera_h camera, int *level);
 ...
 * @see mmsvc_camera_attr_get_contrast()
 */
int mmsvc_camera_attr_get_contrast_range(camera_h camera, int *min , int *max);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_attr_foreach_supported_whitebalance()
 * @see mmsvc_camera_attr_get_whitebalance()
 */
int mmsvc_camera_attr_set_whitebalance(camera_h camera, camera_attr_whitebalance_e whitebalance);
 ...
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_attr_foreach_supported_whitebalance()
 * @see mmsvc_camera_attr_set_whitebalance()
 */
int mmsvc_camera_attr_get_whitebalance(camera_h camera, camera_attr_whitebalance_e *whitebalance);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @post This function invokes mmsvc_camera_attr_supported_whitebalance_cb() to get all the supported white balances.
 * @see mmsvc_camera_attr_set_whitebalance()
 * @see mmsvc_camera_attr_get_whitebalance()
 * @see	camera_attr_supported_whitebalance_cb()
 */
int mmsvc_camera_attr_foreach_supported_whitebalance(camera_h camera,
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_attr_foreach_supported_effect()
 * @see mmsvc_camera_attr_get_effect()
 */
int mmsvc_camera_attr_set_effect(camera_h camera, camera_attr_effect_mode_e effect);
 ...
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_attr_foreach_supported_effect()
 * @see mmsvc_camera_attr_set_effect()
 */
int mmsvc_camera_attr_get_effect(camera_h camera, camera_attr_effect_mode_e *effect);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @post This function invokes mmsvc_camera_attr_supported_effect_cb() to get all the supported effect modes.
 * @see mmsvc_camera_attr_set_effect()
 * @see mmsvc_camera_attr_get_effect()
 * @see	camera_attr_supported_effect_cb()
 */
int mmsvc_camera_attr_foreach_supported_effect(camera_h camera,
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_attr_foreach_supported_scene_mode()
 * @see mmsvc_camera_attr_get_scene_mode()
 */
int mmsvc_camera_attr_set_scene_mode(camera_h camera, camera_attr_scene_mode_e mode);
 ...
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see	camera_attr_foreach_supported_scene_mode()
 * @see mmsvc_camera_attr_set_scene_mode()
 */
int mmsvc_camera_attr_get_scene_mode(camera_h camera, camera_attr_scene_mode_e *mode);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @post This function invokes mmsvc_camera_attr_supported_scene_mode_cb() to get all the supported scene modes.
 * @see	camera_attr_set_scene_mode()
 * @see mmsvc_camera_attr_get_scene_mode()
 * @see mmsvc_camera_attr_supported_scene_mode_cb()
 */
int mmsvc_camera_attr_foreach_supported_scene_mode(camera_h camera,
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see         mmsvc_camera_attr_is_enabled_tag()
 */
int mmsvc_camera_attr_enable_tag(camera_h camera, bool enable);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see         mmsvc_camera_attr_enable_tag()
 */
int mmsvc_camera_attr_is_enabled_tag(camera_h camera, bool *enabled);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_attr_get_tag_image_description()
 */
int mmsvc_camera_attr_set_tag_image_description(camera_h camera, const char *description);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_attr_set_tag_image_description()
 */
int mmsvc_camera_attr_get_tag_image_description(camera_h camera, char **description);
 ...
 */
int mmsvc_camera_attr_set_tag_orientation(camera_h camera, camera_attr_tag_orientation_e orientation);
 ...
 */
int mmsvc_camera_attr_get_tag_orientation(camera_h camera, camera_attr_tag_orientation_e *orientation);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_attr_get_tag_software()
 */
int mmsvc_camera_attr_set_tag_software(camera_h camera, const char *software);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_attr_set_tag_software()
 */
int mmsvc_camera_attr_get_tag_software(camera_h camera, char **software);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_attr_get_geotag()
 * @see mmsvc_camera_attr_remove_geotag()
 */
int mmsvc_camera_attr_set_geotag(camera_h camera, double latitude , double longitude, double altitude);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_attr_set_geotag()
 * @see mmsvc_camera_attr_remove_geotag()
 */
int mmsvc_camera_attr_get_geotag(camera_h camera, double *latitude , double *longitude, double *altitude);
 ...
 * @see mmsvc_camera_attr_get_geotag()
 */
int mmsvc_camera_attr_remove_geotag(camera_h camera);
 ...
 * @see	camera_attr_foreach_supported_flash_mode()
 * @see mmsvc_camera_attr_get_flash_mode()
 */
int mmsvc_camera_attr_set_flash_mode(camera_h camera, camera_attr_flash_mode_e mode);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_attr_foreach_supported_flash_mode()
 * @see mmsvc_camera_attr_set_flash_mode()
 */
int mmsvc_camera_attr_get_flash_mode(camera_h camera, camera_attr_flash_mode_e *mode);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @post This function invokes mmsvc_camera_attr_supported_flash_mode_cb() to get all supported flash modes.
 * @see	camera_attr_set_flash_mode()
 * @see mmsvc_camera_attr_get_flash_mode()
 * @see	camera_attr_supported_flash_mode_cb()
 */
int mmsvc_camera_attr_foreach_supported_flash_mode(camera_h camera,
 ...
 * @see mmsvc_camera_set_display_rotation()
 */
int mmsvc_camera_attr_get_lens_orientation(camera_h camera, int *angle);
 ...
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @pre	The camera state must be set to #CAMERA_STATE_CREATED.
 * @see mmsvc_camera_attr_get_stream_rotation()
 */
int mmsvc_camera_attr_set_stream_rotation(camera_h camera , camera_rotation_e rotation);
 ...
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @pre	The camera state must be set to #CAMERA_STATE_CREATED.
 * @see mmsvc_camera_attr_set_stream_rotation()
 */
int mmsvc_camera_attr_get_stream_rotation(camera_h camera , camera_rotation_e *rotation);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @post This function invokes mmsvc_camera_attr_supported_stream_rotation_cb() to get all supported stream rotation mode.
 * @see mmsvc_camera_attr_set_stream_rotation()
 * @see mmsvc_camera_attr_get_stream_rotation()
 * @see mmsvc_camera_attr_supported_stream_rotation_cb()
 */
int mmsvc_camera_attr_foreach_supported_stream_rotation(camera_h camera,
 ...
 * @see mmsvc_camera_attr_set_stream_rotation()
 */
int mmsvc_camera_attr_set_stream_flip(camera_h camera , camera_flip_e flip);
 ...
 * @see mmsvc_camera_attr_set_stream_rotation()
 */
int mmsvc_camera_attr_get_stream_flip(camera_h camera , camera_flip_e *flip);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @post This function invokes mmsvc_camera_attr_supported_stream_flip_cb() to get all supported stream flip mode.
 * @see mmsvc_camera_attr_set_stream_flip()
 * @see mmsvc_camera_attr_get_stream_flip()
 * @see mmsvc_camera_attr_supported_stream_flip_cb()
 */
int mmsvc_camera_attr_foreach_supported_stream_flip(camera_h camera,
 ...
 * @param[in] user_data The user data passed from the callback registration function
 * @pre mmsvc_camera_start_capture() will invoke this callback if you register it using mmsvc_camera_attr_set_hdr_capture_progress_cb().
 * @see mmsvc_camera_attr_get_hdr_mode()
 * @see mmsvc_camera_attr_set_hdr_capture_progress_cb()
 * @see mmsvc_camera_attr_unset_hdr_capture_progress_cb()
 * @see mmsvc_camera_attr_is_supported_hdr_capture()
 */
 ...
 *          If this attribute is set to @c true. mmsvc_camera_attr_hdr_progress_cb() is invoked during capture.\n
 ...
 *
 */
int mmsvc_camera_attr_set_hdr_mode(camera_h camera, camera_attr_hdr_mode_e mode);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_attr_set_hdr_mode()
 * @see mmsvc_camera_attr_set_hdr_capture_progress_cb()
 * @see mmsvc_camera_attr_unset_hdr_capture_progress_cb()
 * @see mmsvc_camera_attr_is_supported_hdr_capture()
 */
int mmsvc_camera_attr_get_hdr_mode(camera_h camera, camera_attr_hdr_mode_e *mode);
 ...
 * @see mmsvc_camera_attr_is_supported_hdr_capture()
 */
int mmsvc_camera_attr_set_hdr_capture_progress_cb(camera_h camera, camera_attr_hdr_progress_cb callback, void* user_data);
 ...
 * @see mmsvc_camera_attr_is_supported_hdr_capture()
 */
int mmsvc_camera_attr_unset_hdr_capture_progress_cb(camera_h camera);
 ...
 * @see mmsvc_camera_attr_unset_hdr_capture_progress_cb()
 */
bool mmsvc_camera_attr_is_supported_hdr_capture(camera_h camera);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_attr_is_enabled_anti_shake()
 * @see mmsvc_camera_attr_is_supported_anti_shake()
 *
 */
int mmsvc_camera_attr_enable_anti_shake(camera_h camera, bool enable);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_attr_enable_anti_shake()
 * @see mmsvc_camera_attr_is_supported_anti_shake()
 */
int mmsvc_camera_attr_is_enabled_anti_shake(camera_h camera , bool *enabled);
 ...
 * @see mmsvc_camera_attr_is_enabled_anti_shake()
 */
bool mmsvc_camera_attr_is_supported_anti_shake(camera_h camera);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_attr_is_enabled_video_stabilization()
 * @see mmsvc_camera_attr_is_supported_video_stabilization()
 *
 */
int mmsvc_camera_attr_enable_video_stabilization(camera_h camera, bool enable);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_attr_enable_video_stabilization()
 * @see mmsvc_camera_attr_is_supported_video_stabilization()
 */
int mmsvc_camera_attr_is_enabled_video_stabilization(camera_h camera, bool *enabled);
 ...
 * @see mmsvc_camera_attr_is_enabled_video_stabilization()
 */
bool mmsvc_camera_attr_is_supported_video_stabilization(camera_h camera);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_attr_is_enabled_auto_contrast()
 */
int mmsvc_camera_attr_enable_auto_contrast(camera_h camera, bool enable);
 ...
 * @retval #CAMERA_ERROR_PERMISSION_DENIED The access to the resources can not be granted
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 * @see mmsvc_camera_attr_enable_auto_contrast()
 */
int mmsvc_camera_attr_is_enabled_auto_contrast(camera_h camera, bool *enabled);
 ...
 * @see mmsvc_camera_attr_is_enabled_auto_contrast()
 */
bool mmsvc_camera_attr_is_supported_auto_contrast(camera_h camera);
 ...
 * @retval #CAMERA_ERROR_NOT_SUPPORTED The feature is not supported
 */
int mmsvc_camera_attr_disable_shutter_sound(camera_h camera, bool disable);
