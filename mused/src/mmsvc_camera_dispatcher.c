...
void _mmsvc_camera_disp_callback_supported_theater_mode(int param, void *user_data)
{
	Client client = (Client)user_data;
	int event;
	event = MMSVC_CAMERA_EVENT_TYPE_FOREACH_SUPPORTED_THEATER_MODE;
	LOGW("Enter!! param : %d", param);
...
void _mmsvc_camera_disp_callback_supported_af_mode(int param, void *user_data)
{
	Client client = (Client)user_data;
	int event;
...
void _mmsvc_camera_disp_callback_supported_exposure_mode(int param, void *user_data)
{
	Client client = (Client)user_data;
	int event;
...
void _mmsvc_camera_disp_callback_supported_iso_mode(int param, void *user_data)
{
	Client client = (Client)user_data;
	int event;
...
void _mmsvc_camera_disp_callback_supported_whitebalance(int param, void *user_data)
{
	Client client = (Client)user_data;
	int event;
...
void _mmsvc_camera_disp_callback_supported_effect(int param, void *user_data)
{
	Client client = (Client)user_data;
	int event;
...
void _mmsvc_camera_disp_callback_supported_scene_mode(int param, void *user_data)
{
	Client client = (Client)user_data;
	int event;
...
void _mmsvc_camera_disp_callback_supported_flash_mode(int param, void *user_data)
{
	Client client = (Client)user_data;
	int event;
...
void _mmsvc_camera_disp_callback_supported_fps(int param, void *user_data)
{
	Client client = (Client)user_data;
	int event;
...
void _mmsvc_camera_disp_callback_supported_fps_by_resolution(int param, void *user_data)
{
	Client client = (Client)user_data;
	int event;
...
void _mmsvc_camera_disp_callback_supported_stream_flip(int param, void *user_data)
{
	Client client = (Client)user_data;
	int event;
...
void _mmsvc_camera_disp_callback_supported_stream_rotation(int param, void *user_data)
{
	Client client = (Client)user_data;
	int event;
...
void _mmsvc_camera_disp_callback_supported_capture_format(int param, void *user_data)
{
	Client client = (Client)user_data;
	int event;
...
void _mmsvc_camera_disp_callback_supported_preview_format(int param, void *user_data)
{
	Client client = (Client)user_data;
	int event;
...
void _mmsvc_camera_disp_callback_supported_preview_resolution(int param1, int param2, void *user_data)
{
	Client client = (Client)user_data;
	int event;
	event = MMSVC_CAMERA_EVENT_TYPE_FOREACH_SUPPORTED_PREVIEW_RESOLUTION;
	LOGW("Enter!! param1 : %d, param2 : %d", param1, param2);
...
void _mmsvc_camera_disp_callback_supported_capture_resolution(int param1, int param2, void *user_data)
{
	Client client = (Client)user_data;
	int event;
...
int mmsvc_camera_disp_is_supported_face_detection(Client client)
{
	int ret = CAMERA_ERROR_NONE;
	int handle;
	...
	mmsvc_camera_msg_get(handle, mmsvc_core_client_get_msg(client));
	LOGW("handle : 0x%x", handle);
	ret = camera_is_supported_face_detection((camera_h)handle);
	LOGW("is supported ret : %d", ret);
	mmsvc_camera_msg_return(api, ret, client);
...
int mmsvc_camera_disp_foreach_supported_preview_resolution(Client client)
{
	...
	ret = camera_foreach_supported_preview_resolution((camera_h)handle,
						(camera_supported_preview_resolution_cb)_mmsvc_camera_disp_callback_supported_preview_resolution,
						(void *)client);
	LOGW("ret : 0x%x", ret);
	mmsvc_camera_msg_return(api, ret, client);
...
int mmsvc_camera_disp_foreach_supported_capture_resolution(Client client)
{
	...
	ret = camera_foreach_supported_capture_resolution((camera_h)handle,
						(camera_supported_capture_resolution_cb)_mmsvc_camera_disp_callback_supported_capture_resolution,
						(void *)client);
	LOGW("ret : 0x%x", ret);
	mmsvc_camera_msg_return(api, ret, client);
...
int mmsvc_camera_disp_foreach_supported_capture_format(Client client)
{
	...
	ret = camera_foreach_supported_capture_format((camera_h)handle,
						(camera_supported_capture_format_cb)_mmsvc_camera_disp_callback_supported_capture_format,
						(void *)client);
	LOGW("ret : 0x%x", ret);
	mmsvc_camera_msg_return(api, ret, client);
...
int mmsvc_camera_disp_foreach_supported_preview_format(Client client)
{
	...
	ret = camera_foreach_supported_preview_format((camera_h)handle,
						(camera_supported_preview_format_cb)_mmsvc_camera_disp_callback_supported_preview_format,
						(void *)client);
	LOGW("ret : 0x%x", ret);
	mmsvc_camera_msg_return(api, ret, client);
...
int mmsvc_camera_disp_attr_foreach_supported_theater_mode(Client client)
{
	...
	ret = camera_attr_foreach_supported_theater_mode((camera_h)handle,
						(camera_attr_supported_theater_mode_cb)_mmsvc_camera_disp_callback_supported_theater_mode,
						(void *)client);
...
int mmsvc_camera_disp_attr_foreach_supported_af_mode(Client client)
{
	...
	ret = camera_attr_foreach_supported_af_mode((camera_h)handle,
						(camera_attr_supported_af_mode_cb)_mmsvc_camera_disp_callback_supported_af_mode,
						(void *)client);
	LOGW("ret : 0x%x", ret);
	mmsvc_camera_msg_return(api, ret, client);
...
int mmsvc_camera_disp_attr_foreach_supported_exposure_mode(Client client)
{
	...
	mmsvc_camera_msg_get(handle, mmsvc_core_client_get_msg(client));
	LOGW("handle : 0x%x, api : %d", handle, api);

	ret = camera_attr_foreach_supported_exposure_mode((camera_h)handle,
						(camera_attr_supported_exposure_mode_cb)_mmsvc_camera_disp_callback_supported_exposure_mode,
						(void *)client);
	LOGW("ret : 0x%x", ret);
	mmsvc_camera_msg_return(api, ret, client);
...
int mmsvc_camera_disp_attr_foreach_supported_iso(Client client)
{
	...
	ret = camera_attr_foreach_supported_iso((camera_h)handle,
						(camera_attr_supported_iso_cb)_mmsvc_camera_disp_callback_supported_iso_mode,
						(void *)client);
	LOGW("ret : 0x%x", ret);
	mmsvc_camera_msg_return(api, ret, client);
...
int mmsvc_camera_disp_attr_foreach_supported_whitebalance(Client client)
{
	...
	ret = camera_attr_foreach_supported_whitebalance((camera_h)handle,
						(camera_attr_supported_whitebalance_cb)_mmsvc_camera_disp_callback_supported_whitebalance,
						(void *)client);
	LOGW("ret : 0x%x", ret);
	mmsvc_camera_msg_return(api, ret, client);
...
int mmsvc_camera_disp_attr_foreach_supported_effect(Client client)
{
	...
	ret = camera_attr_foreach_supported_effect((camera_h)handle,
						(camera_attr_supported_effect_cb)_mmsvc_camera_disp_callback_supported_effect,
						(void *)client);
	LOGW("ret : 0x%x", ret);
	mmsvc_camera_msg_return(api, ret, client);
...
int mmsvc_camera_disp_attr_foreach_supported_scene_mode(Client client)
{
	...
	ret = camera_attr_foreach_supported_scene_mode((camera_h)handle,
						(camera_attr_supported_scene_mode_cb)_mmsvc_camera_disp_callback_supported_scene_mode,
						(void *)client);
	LOGW("ret : 0x%x", ret);
	mmsvc_camera_msg_return(api, ret, client);
...
int mmsvc_camera_disp_attr_foreach_supported_flash_mode(Client client)
{
	...
	ret = camera_attr_foreach_supported_flash_mode((camera_h)handle,
						(camera_attr_supported_flash_mode_cb)_mmsvc_camera_disp_callback_supported_flash_mode,
						(void *)client);
	LOGW("ret : 0x%x", ret);
	mmsvc_camera_msg_return(api, ret, client);
...
int mmsvc_camera_disp_attr_foreach_supported_fps(Client client)
{
	...
	ret = camera_attr_foreach_supported_fps((camera_h)handle,
						(camera_attr_supported_fps_cb)_mmsvc_camera_disp_callback_supported_fps,
						(void *)client);
	LOGW("ret : 0x%x", ret);
	mmsvc_camera_msg_return(api, ret, client);
...
int mmsvc_camera_disp_attr_foreach_supported_fps_by_resolution(Client client)
{
	...
	ret = camera_attr_foreach_supported_fps_by_resolution((camera_h)handle,
						width, height,
						(camera_attr_supported_fps_cb)_mmsvc_camera_disp_callback_supported_fps_by_resolution,
						(void *)client);
	LOGW("ret : 0x%x", ret);
	mmsvc_camera_msg_return(api, ret, client);
...
int mmsvc_camera_disp_attr_foreach_supported_stream_flip(Client client)
{
	...
	ret = camera_attr_foreach_supported_stream_flip((camera_h)handle,
						(camera_attr_supported_stream_flip_cb)_mmsvc_camera_disp_callback_supported_stream_flip,
						(void *)client);
	LOGW("ret : 0x%x", ret);
	mmsvc_camera_msg_return(api, ret, client);
...
int mmsvc_camera_disp_attr_foreach_supported_stream_rotation(Client client)
{
	...
	ret = camera_attr_foreach_supported_stream_rotation((camera_h)handle,
						(camera_attr_supported_stream_rotation_cb)_mmsvc_camera_disp_callback_supported_stream_rotation,
						(void *)client);
	LOGW("ret : 0x%x", ret);
	mmsvc_camera_msg_return(api, ret, client);
...
int (*dispatcher[MMSVC_CAMERA_API_MAX]) (Client client) = {
	...
	mmsvc_camera_disp_is_supported_face_detection,		/* MMSVC_CAMERA_API_SUPPORT_FACE_DETECTION, */
